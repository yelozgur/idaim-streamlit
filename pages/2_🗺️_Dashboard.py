...
if last_bounds:
    south, west, north, east = utils.parse_folium_bounds(last_bounds)
    if south is not None:
        ...
        # Parse başarısız — eski session state'i temizle
...
# Bounds'u session_state'e kaydet (normalize edilmiş formatta)
if map_data and map_data.get("bounds"):
    south, west, north, east = utils.parse_folium_bounds(map_data["bounds"])
    if south is not None:
        # Normalize: [[south, west], [north, east]] formatında sakla
        st.session_state["last_map_bounds"] = [[south, west], [north, east]]
